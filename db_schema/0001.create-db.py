step(
  ...
  CREATE TABLE `event_badges_events` (
      ...
      CONSTRAINT `fk_event_badges_events_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CREATE TABLE `event_participant_badges` (
      ...
      CONSTRAINT `fk_event_participant_badges_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CREATE TABLE `event_participants` (
      ...
      CONSTRAINT `fk_event_participants_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
